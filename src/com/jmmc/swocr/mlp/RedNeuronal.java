...
public class RedNeuronal implements Serializable, MLP {
    ...
    public void entrenarRed(byte[][] entradas, double[][] salidas, double learningRate, int numero_epocas) {
        ...
        // calcular delta, factor de error y actualizar los bias y pesos de todas las neuronas
...
//                System.out.println("\tE =" + e);
    ...
    public String toString() {
        ...
        for (int i = 0; i < n.length; i++) {
            ...
            for (Sinapsis s : ss) {
                sb.append("\t\t");
                sb.append("Sinapsis: Peso=").append(s.getPeso()).append("\t\tbias de receptor=").append(s.getReceptor().getBias());
                sb.append("\n");
            }
        }
