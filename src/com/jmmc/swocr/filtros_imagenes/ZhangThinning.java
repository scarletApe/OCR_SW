 ...
 */
public class ZhangThinning {

    /**
     * @param givenImage
     * @param changeGivenImage decides whether the givenArray should be modified
     * or a clone should be used
     * @return a 2D array of binary image after thinning using zhang-suen
     * thinning algo.
     */
