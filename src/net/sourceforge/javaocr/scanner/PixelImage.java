...
public class PixelImage {
	...
	protected static final float[] FILTER_FIR_COEFFS = { 0.05001757311983922f, -0.06430830829693616f,
			-0.0900316316157106f, 0.1500527193595177f, 0.45015815807855303f, 0.45015815807855303f, 0.1500527193595177f,
			-0.0900316316157106f, -0.06430830829693616f, 0.05001757311983922f, };
	/**
	 ...
	 * 
	 * @param pixels
	 *            An array of pixels. This can be in RGBA or grayscale. By
	 *            default, it is RGBA, but if the <code>toGrayScale()</code>
	 *            method has been called, each pixel will be in the range of
	 *            0-255 grayscale.
	 * @param width
	 *            Width of the image, in pixels.
	 * @param height
	...
	/**
	 * Construct a new <code>PixelImage</code> object from an <code>Image</code>
	 * .
	 * 
	 * @param image
	 *            An <code>Image</code> from which to get the pixels. The image
	 *            must be fully loaded. Use a <code>MediaTracker</code> to
	 ...
	 * 
	 * @param normalize
	 *            <code>true</code> to normalize the image after converting to
	 *            grayscale, such that the darkest pixel in the image is all
