...
public interface DocumentScannerListener {
	 ...
	 * 
	 * @param pixelImage
	 *            The <code>PixelImage</code> containing the document which is
	 *            being scanned.
	 */
	 ...
	 *            being scanned.
	 * @param y1
	 *            The y position of the top pixel row of the row of text that is
	 *            being scanned.
	 * @param y2
	 *            The y position of the pixel row immediately below the last
	 *            pixel row of the row of text that is being scanned. This is
	 *            always one more than the last pixel row of the row of text
	 ...
	 *            being scanned.
	 * @param x1
	 *            The x position of the first pixel column of the character or
	 *            group of characters being scanned.
	 * @param y1
	 *            The y position of the top pixel row of the row of text that is
	 *            being scanned.
	 * @param x2
	 *            The x position of the pixel column immediately to the right of
	 *            the last pixel column of the character or group of characters
	 *            being scanned. This is always one more than the last pixel
	 *            column of the character or group of characters that is being
	 *            scanned.
	 * @param y2
	 *            The y position of the pixel row immediately below the last
	 *            pixel row of the row of text that is being scanned. This is
	 ...
	 *            that is being scanned.
	 * @param rowY1
	 *            The y position of the top scan line of the row.
	 * @param rowY2
	 *            The y position of the scan line immediately below the bottom
	 *            of the row.
	 */
